/*  FILE:   OUTPUT_MONSTERS.CPP

    Copyright (c) 2008 by Lone Wolf Development, Inc.  All rights reserved.
...
T_Status    C_DDI_Monsters::Post_Process_Entry(T_XML_Node root, T_Monster_Info * info)
{
